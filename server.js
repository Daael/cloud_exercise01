...
app.get('/api', (req, res) => {
  ...
  res.json({
    ...
    endpoints: [
      ...
      {method: 'PUT', path: '/api/books/', description: 'Update a book information'},
...
app.get('/api/profile', (req, res) => {
  res.json({
    ...
    'email': 'yann@facebook.com',
    'deployedURLLink': '',//leave this blank for the first exercise
    'apiDocumentationURL': '', //leave this also blank for the first exercise
    'currentCity': 'New York',
    'hobbies': ['machine learning', 'computer vision', 'mobile robotics', 'computational neuroscience.']
